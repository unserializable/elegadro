package org.elegadro.parser.rt.xml.visitor;
...
import org.elegadro.parser.util.rt.LawParseUtil;
import org.elegadro.rt.legal.LegalMolecul;
import org.elegadro.rt.legal.LegalParticle;
import org.elegadro.rt.legal.impl.*;
import org.elegadro.util.Memoizer;

import java.util.Deque;
import java.util.LinkedList;
import java.util.function.Function;

import static org.elegadro.parser.util.rt.LegalNumberUtil.legalNumberFor;
...
public class SeadusVisitor extends BaseVisitor<LegalParticle, RuntimeException> implements TraversingVisitorProgressMonitor {
    ...
    private Function<Class<? extends Visitable>, Boolean> hasOwnV4clazz = Memoizer.memoize(
